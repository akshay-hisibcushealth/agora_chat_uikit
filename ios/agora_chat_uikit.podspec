...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'A set of ui components adapted to the chat sdk can quickly build a chat page   and chat through the chat sdk by invoking the ui components.'
  s.description      = <<-DESC
A set of ui components adapted to the chat sdk can quickly build a chat page   and chat through the chat sdk by invoking the ui components.
  ...
  # s.resource_bundles = {'agora_chat_uikit_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
